      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
               ...
               currentTheme === 'neon' ? 'text-white' : 'text-blue-900 dark:text-blue-100'
             }`}>
               Task Title *
             </label>
            <input
              ...
              className={`w-full px-3 py-2 text-sm rounded-lg border transition-all duration-200 ${
                currentTheme === 'neon'
                  ...
                  : 'bg-white dark:bg-gray-700 border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white placeholder-gray-400 focus:border-blue-500'
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              className={`w-full px-3 py-2 text-sm rounded-lg border transition-all duration-200 resize-none ${
                currentTheme === 'neon'
                  ? 'bg-gray-800 border-gray-600 text-white placeholder-gray-400 focus:border-cyan-500'
                  : 'bg-white dark:bg-gray-700 border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white placeholder-gray-400 focus:border-blue-500'
              } focus:outline-none focus:ring-2 focus:ring-blue-500/20`}
              ...
              <select
                ...
                className={`w-full px-3 py-2 text-sm rounded-lg border transition-all duration-200 ${
                  currentTheme === 'neon'
                    ...
                    : 'bg-white dark:bg-gray-700 border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white focus:border-blue-500'
                } focus:outline-none focus:ring-2 focus:ring-blue-500/20`}
              >
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
                             <label className={`block_text-xs font-medium mb-1.5 ${
                 currentTheme === 'neon' ? 'text-white' : 'text-blue-900 dark:text-blue-100'
               }`}>
                 Due Time
               </label>
